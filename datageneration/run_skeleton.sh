...
array=([106]='10_04') #[743]='ung_74_01') #[790]='ung_77_28')
# SET PATHS HERE
...
do
    ...
    echo $JOB_PARAMS
    $BLENDER_PATH/blender -b -t 4 -P main_part_low_freq.py --- ${JOB_PARAMS}
    rm -rf "/home/local/data/cmc/synthetic/run0/${name}_skeleton_f"
    mv "/home/local/data/cmc/synthetic/run0/${name}" "/home/local/data/cmc/synthetic/run0/${name}_skeleton_f"
    ((subject_id++))
done
